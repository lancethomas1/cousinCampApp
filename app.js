...
(function () {
  ...
  function renderAwards() {
    ...
    head.innerHTML = `<h2 class="view-title">Camp Awards 🏆</h2>
      <p class="view-sub">Every traveler wins — collect badges across time and claim your prize!</p>`;
    frag.appendChild(head);
  ...
  function claimReward(rewardId) {
    ...
    if (pointsFor(state.me) < r.cost) { toast(`Need ⭐ ${r.cost} — keep traveling!`); return; }
