...
//
// `lead: "Chris"` (optional) names the grown-up running an activity (e.g.
// "Capoeira with Chris", Papaw's songs, "Free Willy with Lance"). Like `cook`,
...
const SCHEDULE = [
  {
    ...
    activities: [
      ...
      { id: "d1-cap", time: "8:15 AM",  title: "Capoeira with Chris",      emoji: "🥋", location: "Back Yard",        points: 10, lead: "Chris", prep: ["Comfy clothes on", "Shoes tied", "Water bottle filled"], desc: "Move and groove, Brazilian style." },
      ...
      { id: "d1-a5",  time: "8:45 AM",  title: "Papaw with Guitar",        emoji: "🎸", location: "Back Porch",       points: 5,  lead: "Papaw", desc: "Sing along with Papaw." },
      ...
      { id: "d1-a13", time: "1:00 PM",  title: "Pool at Rebecca's",        emoji: "🏊", location: "Rebecca's",        points: 10, lead: "Chris, Lance, Betsy, Jason, Sera, Shannon & Vinny", prep: ["Sunscreen on", "Swimsuit on", "Towel packed", "Water bottle filled"], desc: "Splash and swim." },
      { id: "d1-a14", time: "3:30 PM",  title: "Home",                     emoji: "🏡", location: "Mimi's",           points: 5,  info: true, desc: "Back to base." },
      { id: "d1-a15", time: "4:00 PM",  title: "Slang Hats with Christopher", emoji: "🎩", location: "Living Room",   points: 10, lead: "Christopher", desc: "Time travelers through the decades of slang." },
      ...
      { id: "d1-a18", time: "6:30 PM",  title: "Fishing",                  emoji: "🎣", location: "The Pond",         points: 10, lead: "Chris, Lance, Betsy, Jason, Sera, Shannon & Vinny", prep: ["Bug spray on", "Hat on", "Grabbed a fishing pole"], desc: "Cast a line and see what bites." },
      ...
      { id: "d1-a21", time: "9:00 PM",  title: "Jerry Stories",            emoji: "📖", location: "Upstairs",         points: 5,  lead: "Jerry", desc: "Story time with Jerry." },
  ...
  },
  {
    ...
    activities: [
      ...
      { id: "d2-a4",  time: "8:15 AM",  title: "Capoeira with Chris",      emoji: "🥋", location: "Back Yard",        points: 10, lead: "Chris", prep: ["Comfy clothes on", "Shoes tied", "Water bottle filled"], desc: "Move and groove, Brazilian style." },
      ...
      { id: "d2-a10", time: "1:00 PM",  title: "Swim at Rebecca's",        emoji: "🏊", location: "Rebecca's",        points: 10, lead: "Chris, Lance, Betsy, Jason, Sera, Shannon & Vinny", prep: ["Sunscreen on", "Swimsuit on", "Towel packed", "Water bottle filled"], desc: "Cool off in the pool." },
      { id: "d2-a11", time: "4:00 PM",  title: "Games and Crafts",         emoji: "🎲", location: "Craft Table",      points: 10, desc: "Play and create." },
      { id: "d2-a12", time: "5:00 PM",  title: "Free Willy with Lance",    emoji: "🐳", location: "TV Room",          points: 10, lead: "Lance", desc: "Movie time with Uncle Lance." },
      { id: "d2-a13", time: "5:30 PM",  title: "Dinner",                   emoji: "🍽️", location: "Back Porch",       points: 5,  info: true, cook: "Hines", desc: "Eat together outside." },
      { id: "d2-a14", time: "6:30 PM",  title: "Futrell Farm",             emoji: "🚜", location: "Futrell Farm",     points: 10, lead: "Chris, Lance, Betsy, Jason, Sera, Shannon & Vinny", prep: ["Closed-toe shoes on", "Bug spray on", "Hat on"], desc: "Adventure on the farm." },
  ...
  },
  {
    ...
    activities: [
      ...
      { id: "d3-a3",  time: "8:10 AM",  title: "Get Dressed & Pack",       emoji: "🎒", location: "Upstairs",           points: 10, lead: "Chris, Lance, Betsy, Jason, Sera, Shannon & Vinny", prep: ["Swimsuit on under clothes", "Cabin bag packed", "PJs & toothbrush packed"], desc: "Bathing suit under your clothes — and pack for the cabin!" },
      { id: "d3-cap", time: "8:15 AM",  title: "Capoeira with Chris",      emoji: "🥋", location: "Back Yard",          points: 10, lead: "Chris", prep: ["Comfy clothes on", "Shoes tied", "Water bottle filled"], desc: "Move and groove, Brazilian style." },
  ...
  },
  {
    ...
    activities: [
      ...
      { id: "d4-a3",  time: "9:00 AM",  title: "Practice Variety Show",    emoji: "🎭", location: "The Cabin",          points: 15, info: true, desc: "Rehearse at the cabin." },
      { id: "d4-a4",  time: "10:00 AM", title: "Check Out of Hotel",       emoji: "🧳", location: "The Cabin",          points: 5,  info: true, desc: "Pack up and check out." },
      { id: "d4-a5",  time: "10:15 AM", title: "Swim in Pool",             emoji: "🏊", location: "The Pool",           points: 10, lead: "Chris, Lance, Betsy, Jason, Sera, Shannon & Vinny", prep: ["Sunscreen on", "Swimsuit on", "Towel packed", "Snack grabbed"], desc: "One more swim — snacks too!" },
      ...
      { id: "d4-a8",  time: "3:30 PM",  title: "Sera, Korea",              emoji: "🇰🇷", location: "Church",             points: 10, lead: "Sera", desc: "Sera shares about Korea." },
      ...
      { id: "d4-a13", time: "8:00 PM",  title: "Water Balloon Fight",     emoji: "🎈", location: "Back Yard",          points: 10, lead: "Lance", prep: ["Play clothes on", "Filled some balloons", "Ready to get soaked!"], desc: "Soak everyone!" },
  ...
  },
  {
    ...
    activities: [
      ...
      { id: "d5-cap", time: "8:15 AM",  title: "Capoeira with Chris",      emoji: "🥋", location: "Back Yard",        points: 10, lead: "Chris", prep: ["Comfy clothes on", "Shoes tied", "Water bottle filled"], desc: "Move and groove, Brazilian style." },
      ...
      { id: "d5-a7",  time: "11:00 AM", title: "Lazer Tag",                emoji: "🔫", location: "Lazer Tag",        points: 15, lead: "Chris, Lance, Betsy, Jason, Sera, Shannon & Vinny", prep: ["Closed-toe shoes on", "Water bottle filled", "Ready to run!"], desc: "Suit up and tag 'em!" },
      ...
      { id: "d5-a11", time: "5:00 PM",  title: "Pontoon Boat & Jet Skis",  emoji: "🚤", location: "The Lake",         points: 20, lead: "Chris, Lance, Betsy, Jason, Sera, Shannon & Vinny", cook: "Sera & Betsy (dinner on the boat)", prep: ["Sunscreen on", "Swimsuit on", "Life jacket grabbed", "Towel packed"], desc: "Cruise on the pontoon and take turns on the 2 jet skis!" },
